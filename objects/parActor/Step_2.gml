...
if (hand_item.name != undefined && hand_item.sprites != struct_get(sprites.hand_item, hand_item.name)){
	hand_item.sprites = struct_get(sprites.hand_item, hand_item.name);
}
